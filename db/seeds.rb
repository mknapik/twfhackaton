...
lyzwa = dodaj_obrazek('łyżwa','/seasons/iceskateshoe.png')
...
zima.dodaj_kategorie('Sport', [nartybiegowe,plywanie,surfowanie,narty,zaglowanie,rower,lyzwy])
...
lato.dodaj_kategorie('Odzież i obuwie', [rekawiczki,japonki,czapka,kurtkazimowa,spodenki,sweter,spodnie])
lato.dodaj_kategorie('Inne', [lody,sanki,palma,lyzwa,suszarka,komputer])
...
plywak = Gra.stworz('Basen', 'Co należy zabrać na basen?', '/seasons/swimming.png')
...
plywak.dodaj_kategorie('Przedmioty', [czepek,kapielowki,lyzwy,suszarka,lornetka,klapki,buty,telefon,strojkapielowy,latarka,pletwy,komputer,szampon,szpilki,noz,otwieracz])

plywak.ma_poprawna_odpowiedz(czepek)
plywak.ma_poprawna_odpowiedz(suszarka)
plywak.ma_poprawna_odpowiedz(strojkapielowy)
plywak.ma_poprawna_odpowiedz(pletwy)
plywak.ma_poprawna_odpowiedz(szampon)
plywak.ma_poprawna_odpowiedz(kapielowki)
plywak.ma_poprawna_odpowiedz(klapki)
